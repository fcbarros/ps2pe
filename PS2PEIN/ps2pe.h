...
typedef double (CALLBACK *EMUGETCLOCK)( void );
typedef void (CALLBACK *EMUINITIALIZE)( void );
typedef void (CALLBACK *EMURELEASE)( void );
typedef EMU_U32 (CALLBACK *EMUGETTOTALINSTRUCTIONS)( void );
...
typedef void (CALLBACK *EMUGSINITWINDOW)( void );
typedef void (CALLBACK *EMUGSCONFIGURE)( void );
typedef void (CALLBACK *EMUGSCLOSEWINDOW)( void );
...
typedef void (CALLBACK *EMURESET)( void );
typedef BOOL (CALLBACK *EMUFINDLABEL)( char * Label, EMU_U32 * LabelIndex );
typedef void (CALLBACK *EMUPADCONFIG)( void );
typedef void (CALLBACK *EMUCONFIG)( void );
