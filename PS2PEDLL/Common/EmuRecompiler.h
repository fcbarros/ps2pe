...
#define EMUFUNCTION     emuExecute //EmuRecInterpret
...
#define EXECUTE_BRANCH( addr )                                                      \
        EMU_U32 JumpToTmp = R5900Regs.PC + (((EMU_I16)R_BRANCH) << 2);              \
        EXECUTE_BRANCH_DELAY_SLOT( addr );                                          \
        R5900Regs.PC = JumpToTmp;
...
#define COMPAREINTREGS( r1, r2, i1, i2, idx )                           \
    if ( ( r1 >= 0 ) && ( r2 >= 0 ) )                                   \
    {                                                                   \
        CMP32RtoR( r1, r2 );                                            \
    }                                                                   \
    ...
    {                                                                   \
        if ( i2 )                                                       \
        {                                                               \
            CMP32MtoR( r1, (EMU_U32)&R5900Regs.Reg[ i2 ].u32[ idx ] );  \
        }                                                               \
        else                                                            \
        {                                                               \
            CMP32ItoR( r1, 0 );                                         \
    ...
    {                                                                   \
        if ( i1 )                                                       \
        {                                                               \
            r1 = EmuRec_GetIntReg( i1, idx, TRUE );                     \
            CMP32RtoR( r1, r2 );                                        \
        }                                                               \
        else                                                            \
        {                                                               \
...
#define COMPAREREGZERO( r1, i1, idx )                                   \
    if ( r1 >= 0 )                                                      \
    {                                                                   \
        CMP32ItoR( r1, 0 );                                             \
    }                                                                   \
    ...
    {                                                                   \
        CMP32ItoM( (EMU_U32)&R5900Regs.Reg[ i1 ].u32[ idx ], 0 );       \
    }


#define SETLINK8( link )    *link = EmuRec_CurrentAddress( ) - link - 1

#define SETLINK32( link )    *link = (EMU_U32)EmuRec_CurrentAddress( ) - (EMU_U32)link - 4
