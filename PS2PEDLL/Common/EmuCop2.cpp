	...
	if (Code & 0x02000000)
	{
		...
		default:
			...
			case 0x000003BC: // "vdiv"
				switch (VU_FSF)
				{
				case 0: emuTemp.TempF32 = VU0Regs.CPR[VU_FS].X.f;   break;
				case 1: emuTemp.TempF32 = VU0Regs.CPR[VU_FS].Y.f;   break;
				case 2: emuTemp.TempF32 = VU0Regs.CPR[VU_FS].Z.f;   break;
				case 3: emuTemp.TempF32 = VU0Regs.CPR[VU_FS].W.f;   break;
				}
				switch (VU_FTF)
				{
				case 0: VU0Regs.Q.f = emuTemp.TempF32 / VU0Regs.CPR[VU_FT].X.f;   break;
				case 1: VU0Regs.Q.f = emuTemp.TempF32 / VU0Regs.CPR[VU_FT].Y.f;   break;
				case 2: VU0Regs.Q.f = emuTemp.TempF32 / VU0Regs.CPR[VU_FT].Z.f;   break;
				case 3: VU0Regs.Q.f = emuTemp.TempF32 / VU0Regs.CPR[VU_FT].W.f;   break;
				}
				break;
			...
			case 0x000003BE: // "vrsqrt"
				...
				switch (VU_FTF)
				{
				case 0: VU0Regs.Q.f = emuTemp.TempF32 / (float)(sqrt(VU0Regs.CPR[VU_FT].X.f));   break;
				case 1: VU0Regs.Q.f = emuTemp.TempF32 / (float)(sqrt(VU0Regs.CPR[VU_FT].Y.f));   break;
				case 2: VU0Regs.Q.f = emuTemp.TempF32 / (float)(sqrt(VU0Regs.CPR[VU_FT].Z.f));   break;
				case 3: VU0Regs.Q.f = emuTemp.TempF32 / (float)(sqrt(VU0Regs.CPR[VU_FT].W.f));   break;
				}
				break;
