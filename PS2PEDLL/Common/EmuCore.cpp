...
void EmuCore(EMU_U32 Code)
{
	...
	case 0x68000000: // "ldl"
		...
		R5900Regs.Reg[RT].u64_00_63 = (R5900Regs.Reg[RT].u64_00_63 & (0xFFFFFFFFFFFFFFFF >> (SA << 3))) | TempU64;
		break;
	...
	case 0x6C000000: // "ldr"
		...
		R5900Regs.Reg[RT].u64_00_63 = (R5900Regs.Reg[RT].u64_00_63 & (0xFFFFFFFFFFFFFFFF << ((7 - SA) << 3))) | TempU64;
		break;
	...
	case 0x7C000000: // "sq"
		Address = R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE;
		EmuMemSetDWord(Address, R5900Regs.Reg[R_RT].u64_00_63);
		EmuMemSetDWord(Address + 8, R5900Regs.Reg[R_RT].u64_64_127);
		break;

	case 0x80000000: // "lb"
		R5900Regs.Reg[R_RT].u64_00_63 = (EMU_I08)EmuMemGetByte(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE);
		break;

	case 0x84000000: // "lh"
		R5900Regs.Reg[R_RT].u64_00_63 = (EMU_I16)EmuMemGetShort(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE);
		break;
	...
	case 0x8C000000: // "lw"
		R5900Regs.Reg[R_RT].i64_00_63 = (EMU_I32)EmuMemGetWord(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE);
		break;

	case 0x90000000: // "lbu"
		R5900Regs.Reg[R_RT].u64_00_63 = EmuMemGetByte(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE);
		break;

	case 0x94000000: // "lhu"
		R5900Regs.Reg[R_RT].u64_00_63 = EmuMemGetShort(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE);
		break;
	...
	case 0xA0000000: // "sb"
		EmuMemSetByte(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE, R5900Regs.Reg[R_RT].u08_00_07);
		break;

	case 0xA4000000: // "sh"
		EmuMemSetShort(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE, R5900Regs.Reg[R_RT].u16_00_15);
		break;
	...
	case 0xA8000000: // "swl"
		...
		Address = R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE;
		SA = Address & 0x3;
		TempU32 = (EmuMemGetWord(Address - 3) & (0xFFFFFFFF >> ((SA + 1) << 3))) | (R5900Regs.Reg[RT].u32_00_31 & (0xFFFFFFFF << ((3 - SA) << 3)));
		EmuMemSetWord(Address - 3, TempU32);
		break;

	case 0xAC000000: // "sw"
		EmuMemSetWord(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE, R5900Regs.Reg[R_RT].u32_00_31);
		break;
	...
	case 0xC4000000: // "lwc1"      
		TempU32 = EmuMemGetWord(R5900Regs.Reg[R_RS].u32_00_31 + (EMU_I16)R_IMMEDIATE);
