                                     ...
                                     BOOL * IsImplemented )
{
   ...
   *IsDisassembled = ( EmuInstructions[ InstIndex ].Disassembly &&
                      EmuInstructions[ InstIndex ].Disassembly != EmuDis_REGISTERED );
...
DLLEXPORT void CALLBACK EmuGSInitWindow( void )
{
   Emu_GS_InitWindow( );
}

DLLEXPORT void CALLBACK EmuGSConfigure( void )
{
    Emu_GS_Configure( );
}

DLLEXPORT void CALLBACK EmuGSCloseWindow( void )
{
    Emu_GS_CloseWindow( );
}

DLLEXPORT void CALLBACK EmuPADConfig( void )
{
	Emu_PAD_Config( );
}
