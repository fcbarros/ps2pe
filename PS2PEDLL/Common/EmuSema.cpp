...
{ // 0x40
	PS2Regs.R5900Regs.V0.u64_00_63 = Emu_Sema_Create( PS2Regs.R5900Regs.A0.u32_00_31 );
}

void Emu_Sema_Bios_Delete( void )
{ // 0x41
	PS2Regs.R5900Regs.V0.u64_00_63 = Emu_Sema_Delete( PS2Regs.R5900Regs.A0.u32_00_31 );
}

void Emu_Sema_Bios_Signal( void )
{ // 0x42
	PS2Regs.R5900Regs.V0.u64_00_63 = Emu_Sema_Signal( PS2Regs.R5900Regs.A0.u32_00_31 );
}

void Emu_Sema_Bios_Wait( void )
{ // 0x44
	PS2Regs.R5900Regs.V0.u64_00_63 = Emu_Sema_Wait( PS2Regs.R5900Regs.A0.u32_00_31 );
}

void Emu_Sema_Bios_Poll( void )
{ // 0x44
	PS2Regs.R5900Regs.V0.u64_00_63 = Emu_Sema_Poll( PS2Regs.R5900Regs.A0.u32_00_31 );
}
