...
void EmuRec_mult1( EMU_U32 Code )
{
    ...
    if ( R_RS && R_RT )
    {
        ...
        MOV32RtoM( (EMU_U32)&R5900Regs.LO.u32_64_95, EAX );
        SAR32ItoR( EAX, 31 );
        MOV32RtoM( (EMU_U32)&R5900Regs.LO.u32_96_127, EAX );

        MOV32RtoM( (EMU_U32)&R5900Regs.HI.u32_64_95, EDX );
        SAR32ItoR( EDX, 31 );
        MOV32RtoM( (EMU_U32)&R5900Regs.HI.u32_96_127, EDX );

        if ( R_RD )
        {
            RegRD0 = EmuRec_GetIntReg( R_RD, 0, FALSE );
            RegRD1 = EmuRec_GetIntReg( R_RD, 1, FALSE );
            MOV32MtoR( RegRD0, (EMU_U32)&R5900Regs.LO.u32_64_95 );
            MOV32MtoR( RegRD1, (EMU_U32)&R5900Regs.LO.u32_96_127 );
    ...
    {
        MOV32ItoM( (EMU_U32)&R5900Regs.LO.u32_64_95, 0 );
        MOV32ItoM( (EMU_U32)&R5900Regs.HI.u32_64_95, 0 );
        MOV32ItoM( (EMU_U32)&R5900Regs.LO.u32_96_127, 0 );
        MOV32ItoM( (EMU_U32)&R5900Regs.HI.u32_96_127, 0 );
        if ( R_RD )
        {
            RegRD0 = EmuRec_GetIntReg( R_RD, 0, FALSE );
            RegRD1 = EmuRec_GetIntReg( R_RD, 1, FALSE );
